...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(110, 60, 331, 71))
        ...
        self.txt_cipher_text.setGeometry(QtCore.QRect(110, 180, 331, 71))
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(110, 270, 75, 23))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(370, 270, 75, 23))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.txt_key = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(110, 140, 331, 31))
