...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(100, 50, 321, 61))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.txt_key = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(100, 120, 321, 31))
        self.txt_key.setObjectName("txt_key")
        self.txt_cipher_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(100, 160, 321, 71))
        ...
        self.label_4.setGeometry(QtCore.QRect(110, 10, 241, 21))
        font = QtGui.QFont()
